...
namespace CurriculumVitae.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Institution,Degree,From,To,ResumeId")] Education education)
        {
            ...
            ViewData["ResumeId"] = new SelectList(_context.Resumes, "Id", "Id", education.ResumeId);
            return View(education);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Institution,Degree,From,To,ResumeId")] Education education)
        {
            if (id != education.Id)
            {
                return NotFound();
