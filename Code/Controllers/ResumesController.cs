...
namespace CurriculumVitae.Controllers
{
    public class ResumesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Phone,Summary,Skills")] Resume resume)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Phone,Summary,Skills")] Resume resume)
        {
            if (id != resume.Id)
            {
                return NotFound();
