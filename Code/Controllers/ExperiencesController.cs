...
namespace CurriculumVitae.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Company,Title,From,To,Description,ResumeId")] Experience experience)
        {
            ...
            ViewData["ResumeId"] = new SelectList(_context.Resumes, "Id", "Id", experience.ResumeId);
            return View(experience);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Company,Title,From,To,Description,ResumeId")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
